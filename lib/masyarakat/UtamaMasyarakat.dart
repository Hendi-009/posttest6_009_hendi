...
import 'package:posttest6_009_hendi/auth/Login.dart';
import 'ProfilMasyarakat.dart';
import 'PajakPBBP2.dart';

class UtamaMasyarakatWidget extends StatefulWidget {
  const UtamaMasyarakatWidget({Key? key}) : super(key: key);

  @override
  _UtamaMasyarakatWidgetState createState() => _UtamaMasyarakatWidgetState();
}
                                ...
                                IconButton(
                                  ...
                                  onPressed: () {
                                      Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                          builder: (context) => const PajakPBBP2Widget()
                                      ),
                                    );
                                  },
                                ),
